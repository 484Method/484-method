# Kit de lançamento — 484 Method

Material pronto pra começar a mandar tráfego pra landing e recrutar a primeira
coorte. Solo, orgânico, público BR. A ordem importa: **rede quente primeiro,
depois conteúdo público.**

- **Landing (link pra tudo):** https://484method.github.io/484-method/landing/
...
e Fundadores. Esses viram sua prova social pro conteúdo público.
...
> grava e recebe feedback de pronúncia em português, e só depois vê a escrita.
> Comecei com as palavras que você já conhece.
>
> Testa de graça (link na bio) e me conta se travou. 👇
>
...
2. **Diagnóstico:** "O problema não é você. É a ordem: te ensinaram a escrita
   antes do som."
3. **O método (vídeo curto seu):** mostre o ciclo — ouça → repita → grave →
   feedback → só então a escrita.
4. **Prova:** um print do antes/depois ou um depoimento da rede quente (passo 1).
5. **CTA + link:** "Abri pras primeiras pessoas. Testa 👉" com o sticker de link
   pra landing.
